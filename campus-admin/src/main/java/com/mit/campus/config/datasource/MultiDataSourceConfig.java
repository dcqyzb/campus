package com.mit.campus.config.datasource;

import com.alibaba.druid.pool.DruidDataSource;
import com.baomidou.mybatisplus.plugins.OptimisticLockerInterceptor;
import com.baomidou.mybatisplus.plugins.PaginationInterceptor;
import com.mit.campus.core.config.properties.DruidProperties;
import com.mit.campus.core.config.properties.MutiDataSourceProperties;
import com.mit.campus.core.datascope.DataScopeInterceptor;
import com.mit.campus.core.mutidatasource.DynamicDataSource;
 ...
 */
@Configuration
@ConditionalOnProperty(prefix = "campus.muti-datasource", name = "open", havingValue = "true")
@EnableTransactionManagement(order = 2)
@MapperScan(basePackages = {"com.mit.campus.modular.*.dao","com.mit.campus.multi.mapper"})
public class MultiDataSourceConfig {

    @Bean
    @ConfigurationProperties(prefix = "campus.muti-datasource")

package com.mit.campus.modular.system.service.impl;
...
import com.mit.campus.modular.system.dao.DictMapper;
...
import static com.mit.campus.core.common.constant.factory.MutiStrFactory.*;
...
public class DictServiceImpl extends ServiceImpl<DictMapper, Dict> implements IDictService {
    ...
    public void addDict(String dictCode,String dictName,String dictTips, String dictValues) {
        ...
        if (dicts != null && dicts.size() > 0) {
            throw new CampusException(BizExceptionEnum.DICT_EXISTED);
        }
        ...
        for (Map<String, String> item : items) {
            ...
            try {
                ...
                throw new CampusException(BizExceptionEnum.DICT_MUST_BE_NUMBER);
            }

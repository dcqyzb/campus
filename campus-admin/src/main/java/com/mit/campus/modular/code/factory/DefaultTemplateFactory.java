package com.mit.campus.modular.code.factory;


import com.mit.campus.CampusApplication;
import com.mit.campus.core.CoreFlag;
...
public class DefaultTemplateFactory {
    ...
    public static GenQo getDefaultParams(){
        ...
        genQo.setAuthor("campus");
        genQo.setProjectPackage(CampusApplication.class.getPackage().getName());

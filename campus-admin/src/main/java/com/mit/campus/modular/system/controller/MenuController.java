...
import com.mit.campus.core.common.constant.dictmap.MenuDict;
import com.mit.campus.core.common.constant.factory.ConstantFactory;
import com.mit.campus.core.common.constant.state.MenuStatus;
...
import com.mit.campus.core.support.BeanKit;
import com.mit.campus.core.util.ToolUtil;
import com.mit.campus.modular.system.model.Menu;
import com.mit.campus.modular.system.service.IMenuService;
import com.mit.campus.modular.system.warpper.MenuWarpper;
...
public class MenuController extends BaseController {
    ...
    public Tip add(@Valid Menu menu, BindingResult result) {
        ...
        if (ToolUtil.isNotEmpty(existedMenuName)) {
            throw new CampusException(BizExceptionEnum.EXISTED_THE_MENU);
        }
    ...
    private void menuSetPcode(@Valid Menu menu) {
        if (ToolUtil.isEmpty(menu.getPcode()) || menu.getPcode().equals("0")) {
            ...
            if (menu.getCode().equals(menu.getPcode())) {
                throw new CampusException(BizExceptionEnum.MENU_PCODE_COINCIDENCE);
            }

package com.mit.campus.rest.modular.auth.converter;

import com.alibaba.fastjson.JSON;
import com.alibaba.fastjson.support.spring.FastJsonHttpMessageConverter;
import com.mit.campus.core.exception.CampusException;
import com.mit.campus.core.support.HttpKit;
import com.mit.campus.core.util.MD5Util;
import com.mit.campus.rest.common.exception.BizExceptionEnum;
import com.mit.campus.rest.config.properties.JwtProperties;
import com.mit.campus.rest.modular.auth.security.DataSecurityAction;
import com.mit.campus.rest.modular.auth.util.JwtTokenUtil;
...
public class WithSignMessageConverter extends FastJsonHttpMessageConverter {
    ...
    public Object read(Type type, Class<?> contextClass, HttpInputMessage inputMessage) throws IOException, HttpMessageNotReadableException {
        ...
        if (encrypt.equals(baseTransferEntity.getSign())) {
            ...
            throw new CampusException(BizExceptionEnum.SIGN_ERROR);
        }
